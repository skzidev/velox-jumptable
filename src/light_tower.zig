//! This file was derived from the 'light_tower' symbol group 
...
pub extern const vexDeviceLightTowerDebugGet: *const fn(device: types.V5_DeviceT, id: i32) callconv(.c) u32;
