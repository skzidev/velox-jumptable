//! This file was derived from the 'optical' symbol group 
...
pub extern const vexDeviceOpticalGestureGet: *const fn(device: types.V5_DeviceT, pData: [*c]types.V5_DeviceOpticalGesture) callconv(.c) u32;
pub extern const vexDeviceOpticalGestureEnable: *const fn(device: types.V5_DeviceT) callconv(.c) void;
pub extern const vexDeviceOpticalGestureDisable: *const fn(device: types.V5_DeviceT) callconv(.c) void;
pub extern const vexDeviceOpticalProximityThreshold: *const fn(device: types.V5_DeviceT, value: i32) callconv(.c) void;
