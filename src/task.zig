...
pub extern const vexTaskPrioritySetWithId: *const fn(callback: [*c]void,ID: i32,priority: u32) callconv(.c) types.undefined;
pub extern const vexTaskRemoveAllUser: *const fn(main: [*c]i32) callconv(.c) types.undefined;
pub extern const vexTaskResumeWithId: *const fn(callback: [*c]void,ID: i32) callconv(.c) types.undefined;
...
pub extern const vexTasksDump: *const fn() callconv(.c) types.undefined;
...
pub extern const vexTaskStopWithId: *const fn(callback: [*c]void,ID: i32) callconv(.c) types.undefined;
pub extern const vexTaskSuspendWithId: *const fn(callback: [*c]void,ID: i32) callconv(.c) types.undefined;
pub extern const vexTaskWaitForExitWithId: *const fn(callback: [*c]void,ID: i32) callconv(.c) types.undefined;
pub extern const vexTaskYield: *const fn() callconv(.c) types.undefined;
